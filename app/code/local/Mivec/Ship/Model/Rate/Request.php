<?php
class Mivec_Ship_Model_Rate_Request extends Mage_Shipping_Model_Carrier_Abstract implements Mage_Shipping_Model_Carrier_Interface
{
    ...
    {
		//helper
		$this->_quoteHelper = Mage::helper('mivec_ship/quote');
...
*/
	...
	{
		//get carriers
		$_carriers = Mage::helper('mivec_ship/carrier')->getCarriers();
    ...
    public function collectRates(Mage_Shipping_Model_Rate_Request $request)
    {
        ...
        $result = Mage::getModel('ship/rate_result');
...
/*        $result->append($this->_getDhlRate($request));
    ...
    protected function _getAirmailRate(Mage_Shipping_Model_Rate_Request $request)
    {
		...
		if ($request->getPackageWeight() < 10) {
			$rate = Mage::getModel('ship/rate_result_method');
