<?php
class Mivec_Ship_Block_Adminhtml_Quote_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
	...
	protected function _beforeToHtml()
	{
		$this->addTab('form_section', array(
		  ...
		  'content'   => $this->getLayout()->createBlock('ship/adminhtml_quote_edit_tab_form')->toHtml(),
		));
