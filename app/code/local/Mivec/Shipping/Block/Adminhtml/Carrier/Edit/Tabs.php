<?php
class Mivec_Shipping_Block_Adminhtml_Carrier_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
	...
	protected function _beforeToHtml()
	{
		$this->addTab('form_section', array(
		  'label'     => "Carrier",
		  //'title'     => 'Carrier',
		  'content'   => $this->getLayout()->createBlock('shipping/adminhtml_carrier_edit_tab_form')->toHtml(),
		));
